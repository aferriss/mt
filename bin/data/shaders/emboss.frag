...
void main(void)
{
    ...
    kernel[0] = 0.0;   kernel[1] = 0.0;   kernel[2] = -0.2;
    kernel[3] = -0.2;   kernel[4] = -0.2;   kernel[5] = 1.0;
    kernel[6] = 0.0;   kernel[7] = 0.0;   kernel[8] = -0.2;
    ...
    gl_FragColor =vec4(sum.rgb + 0.1, 1.0);//vec4(sum.rgb / vec3(0.5, 0.5, 0.5), 1.0) - 0.001 ;
}